...
#define _WIN32_WINNT _WIN32_WINNT_WIN7 // Set minimum operating system targeted to Win7 so the PROCESS_ALL_ACCESS flag doesnt get huge
...
void CallBackFunc(int event, int x, int y, int flags, void* userdata)
{
	...
	{
		std::cout << "M1 (" << -(478 - x) << ", " << 414 - y << ")" << std::endl; // -478 and -414 to fix the (0,0) point
